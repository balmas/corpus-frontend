...
export type NormalizedAnnotatedField = {
	...
	displayName: string;
	/**
	 * Display order of annotations, by their id. Contains all annotations in this annotatedField, including internal ones.
	 * - as defined in indexconfig.yaml
	 * - if not defined: defaults to definition order of annotations in indexconfig.yaml
	 * - if older version of blacklab, generated by front-end in order of Annotations's displayNames.
	 */
	displayOrder: string[];
